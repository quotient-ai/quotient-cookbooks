...
| [Build an OSS Search Engine with Firecrawl, Groq & Quotient](cookbooks/search/firecrawl/fireplexity/README.md) | A fork of Fireplexity enhanced with Quotient monitoring to detect hallucinations and evaluate context relevance in AI search results. | [README](cookbooks/search/firecrawl/fireplexity/README.md) | [Firecrawl](https://firecrawl.dev), [Groq](https://groq.com), [Quotient](https://github.com/quotient-ai) |
| [Build a Financial Analysis Agent with Quotient Traces](cookbooks/agents/research/financial_agent/README.md) | A production-ready financial analysis agent that demonstrates real-time stock data analysis with comprehensive tracing, hallucination detection, and document relevance monitoring. | [README](cookbooks/agents/research/financial_agent/README.md) | [LangChain](https://github.com/langchain-ai/langchain), [OpenAI](https://github.com/openai), [Quotient](https://github.com/quotient-ai) |
| [Evaluate Tool Use with Limbic](cookbooks/benchmarks/tool-use/limbic_tool_use_benchmark.ipynb) | This notebook demonstrates how to evaluate Language Models' ability to use tools correctly using the Limbic Tool-Use Benchmark dataset. | [Open Notebook](cookbooks/benchmarks/tool-use/limbic_tool_use_benchmark.ipynb) | [Together AI](https://www.together.ai/), [Limbic](https://github.com/quotient-ai/limbic), [Hugging Face](https://huggingface.co/) |
